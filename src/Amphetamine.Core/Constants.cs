...
namespace Amphetamine.Core
{
	public static class Constants
	{
		...
		// Environment
		[Obsolete("Removed by OperatingSystem.IsWindows()")]
		public static bool IsWindows10 = OperatingSystem.IsWindows();

		// Links
		public static string HomeLink = "https://www.ennerperez.dev";
		...
		// public static readonly int AlbumTilePadding = 4;
		public static readonly int AlbumTileMargin = 6;

		// Animation
		public static readonly TimeSpan MouseEnterDuration = TimeSpan.FromMilliseconds(50);
		public static readonly TimeSpan MouseLeaveDuration = TimeSpan.FromMilliseconds(200);
		public static readonly TimeSpan SourceChangedImageChangedDuration = TimeSpan.FromMilliseconds(500);
